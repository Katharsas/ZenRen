...
namespace assets
{
    ...
    bool loadInstanceMesh(VERTEX_DATA_BY_MAT& target, VDFS::FileIndex& vdf, const StaticInstance& instance)
    {
    ...
    vector<StaticInstance> loadVobs(vector<ZenLoad::zCVobData>& rootVobs, const VERTEX_DATA_BY_MAT& worldMeshData, const vector<Light>& lightsStatic, const bool isOutdoorLevel)
    {
