...
namespace assets
{
    ...
    VertLookupTree createVertLookup(const BATCHED_VERTEX_DATA& meshData)
    {
    ...
    std::vector<VertKey> rayDownIntersectedNaive(const BATCHED_VERTEX_DATA& meshData, const VEC3& pos, float searchSizeY)
    {
